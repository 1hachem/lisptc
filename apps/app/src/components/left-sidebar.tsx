...
export function LeftSidebar() {
	const { navCollapsed, toggleNav, toggleRight, rightOpen } = useUI();

	if (navCollapsed) {
		return (
			<div className="flex w-[34px] flex-none flex-col items-center gap-3.5 bg-bg1 py-3.5">
				<button
					type="button"
	...
	return (
		<div className="flex w-[214px] flex-none flex-col gap-3.5 bg-bg1 py-3.5">
			...
			<div className="flex flex-col gap-[3px] px-1.5">
				...
				>
					<span className="w-[11px] flex-none text-center text-[11px]">›</span>
